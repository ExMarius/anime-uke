...
echo "   /api/pulse în bundle     : $(echo "$JS" | grep -c '"/pulse"')  (0 = pulse-ul vine din /api/home)"
echo "   lista HERO .webp         : $(echo "$JS" | grep -c 'hero-1\.webp')  (≥1)"
echo "   referințe hero .jpg      : $(echo "$JS" | grep -c 'hero-1\.jpg')  (0 = fără cerere dublă)"
echo
